...
python exp_GAMMAPrimitive/train_GAMMAPredictor.py --cfg MPVAE_2frame_grab_v2
python exp_GAMMAPrimitive/train_GAMMAPredictor.py --cfg MPVAE_2frame_grab_v4 --resume_training 1
